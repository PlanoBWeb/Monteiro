...
else
{
	...
	$arrayIdioma = array(
		...
		'MN_TXT_RL'  		=> '- Acompanhamento das sessões dos certames licitatórios, perante quaisquer órgãos públicos. 
								- Análise e aprovação prévia da documentação do cliente e dos concorrentes.
								- Representação do cliente na retirada de certidões e comparecimentos em vistorias técnicas.',
		'MN_TITULO_IE'  	=> 'Impugnações em Editais',
		'MN_TXT_IE'  		=> '- Petições de impugnações sempre que se apurar a existência de irregularidades em seu conteúdo, que venham a contrariar a lei licitatória.',
