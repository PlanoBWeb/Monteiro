<?php /* Smarty version 2.6.12, created on 2016-04-14 12:02:30
         compiled from direito-empresarial.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Direito Empresarial" />
      <title>Marcos Monteiro Sociedade de Advogados – Direito Empresarial</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_DEMP']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_DEMP']; ?>
</p>
                  </div>
               </div>
            </div>
