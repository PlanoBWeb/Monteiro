...
?>
                              <div class="col-xs-12 col-sm-6 col-md-6 pd-none">
                                 <div class="bloco-noticia-destaque">
                                    <p class="link-desc-noticias font-normal"><a class="txt-desc-noticias font-normal" href="artigo.php?id=<?php echo $this->_tpl_vars['dadosVejaTambem'][$this->_sections['i']['index']]['id']; ?>
