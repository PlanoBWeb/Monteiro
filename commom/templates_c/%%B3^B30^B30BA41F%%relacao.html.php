<?php /* Smarty version 2.6.12, created on 2016-04-28 18:11:43
         compiled from admin/noticias/relacao.html */ ?>
...
?>
                    <a class="<?php if ($this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']] == $_GET['p']): ?> link-pag-ativo <?php endif; ?>" href="adm_usuario.php?acao=pesquisar&p=<?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
"><?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
            ...
            <br>
            <table class="table">
                <h1 class="titulo-pag">Notícias</h1>
                <thead>
                    <tr class="cor-tr-btn">
                        <th>Titulo</th>
...
?>
                        <tr class="hover-tr">
                            ...
                            <td class="hidden-xs-down"><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['data']; ?>
</td>
                            <td>
...
">visualizar</a>  -->
                                    <a class="cor-tr-btn btn-acoes" target="_blank" href="noticia.php?id=<?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['id']; ?>
">visualizar</a> 
...
$this->_sections['j']['last']       = ($this->_sections['j']['iteration'] == $this->_sections['j']['total']);
?>
                        <a class="<?php if ($this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']] == $_GET['p']): ?> link-pag-ativo <?php endif; ?>" href="adm_noticias.php?acao=pesquisar&p=<?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
"><?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
</a>
                    <?php endfor; endif; ?>
                <?php endif; ?>
