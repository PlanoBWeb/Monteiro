<?php /* Smarty version 2.6.12, created on 2016-04-08 15:10:53
...
?>   
            <?php if ($this->_tpl_vars['nmTipo'] <> $this->_tpl_vars['dadosMenuBlogAnoMes'][$this->_sections['i']['index']]['dataMes'][0]): ?>
               <option disabled value=""><?php echo $this->_tpl_vars['dadosMenuBlogAnoMes'][$this->_sections['i']['index']]['dataMes'][0]; ?>
</option>
            <?php endif; ?>
