<?php /* Smarty version 2.6.12, created on 2016-04-15 14:27:36
         compiled from angelica-rebequi-da-motta-santos.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <title>Marcos Monteiro – Advogada Angélica Rebequi.</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_ANGELICA']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_ANGELICA']; ?>
</p>
                     <div class="col-xs-12 col-sm-12 col-md-12 pd-none email-profissional">
                        ...
                        <a href="mailto:adm@gabanmonteiroadv.com.br">adm@gabanmonteiroadv.com.br</a>
                     </div>
                  </div>
               </div>
            </div>
