<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:51
         compiled from Acoes-possessorias-e-Imissao-na-posse.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Ações possessórias e Imissão na posse" />
      <title>Marcos Monteiro Sociedade de Advogados – Ações possessórias e Imissão na posse</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_APIP']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_APIP']; ?>
</p>
                  </div>
               </div>
            </div>
