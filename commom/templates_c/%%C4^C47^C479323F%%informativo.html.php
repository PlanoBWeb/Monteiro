...
: Direito Público  •   26 Fev. 2015</p>
                        ...
                        <br><br>
                        <p class="txt-desc-noticias font-normal">
                           <?php echo $this->_tpl_vars['arrayIdioma']['MN_NOT_FONTE']; ?>
: Governet
>>>>>>> ca5fe7d1914a4a718aea68ce0386b27d039dbf80
                        </p>
                        <br>
...
?>
                           <div class="col-xs-12 col-sm-6 col-md-6 pd-none">
                              <div class="bloco-noticia-destaque">
                                 <p class="link-desc-noticias font-normal"><a class="txt-desc-noticias font-normal" href="informativo.php?id=<?php echo $this->_tpl_vars['dadosVejaTambem'][$this->_sections['i']['index']]['id']; ?>
