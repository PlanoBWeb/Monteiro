<?php /* Smarty version 2.6.12, created on 2015-11-18 14:49:38
         compiled from direito-eleitoral.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas e assessoria completa em todas as áreas do Direito Eleitoral" />
      <title>Marcos Monteiro Sociedade de Advogados – Direito Eleitoral</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_DE']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_DE']; ?>
</p>
                  </div>
               </div>
            </div>
