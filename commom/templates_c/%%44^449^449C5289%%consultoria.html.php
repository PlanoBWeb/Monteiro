...
<html lang="pt">
   <head>
      ...
      <meta name="description" content="Advogados especialistas Consultoria para empresas interessadas em participar de licitações

" />
      <title>Marcos Monteiro Sociedade de Advogados – Consultoria</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_C']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_C']; ?>
</p>
                  </div>
               </div>
            </div>
