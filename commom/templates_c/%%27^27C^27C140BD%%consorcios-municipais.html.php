<?php /* Smarty version 2.6.12, created on 2016-04-14 12:10:56
         compiled from consorcios-municipais.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas Consultoria em criação e dissolução, contratos e licitações" />
      <title>Marcos Monteiro Sociedade de Advogados – Consórcios Municipais</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_CM']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_CM']; ?>
</p>
                  </div>
               </div>
            </div>
