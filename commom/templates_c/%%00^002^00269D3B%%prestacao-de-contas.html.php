<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:12
         compiled from prestacao-de-contas.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em orientação da prestação de contas de acordo com as rígidas regras eleitorais." />
      <title>Marcos Monteiro Sociedade de Advogados – Prestação de Contas</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_PC']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_PC']; ?>
</p>
                  </div>
               </div>
            </div>
