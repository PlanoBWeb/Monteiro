<?php /* Smarty version 2.6.12, created on 2015-11-18 13:13:44
...
<html lang="pt">
   <head>
      ...
      <meta name="description" content="Advogados especialistas em Direito Público." />
      <title>Marcos Monteiro Sociedade de Advogados – Direito Público</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_DP']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_DP']; ?>
</p>
                  </div>
               </div>
            </div>
