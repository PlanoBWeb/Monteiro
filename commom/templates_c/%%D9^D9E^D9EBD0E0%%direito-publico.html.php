<?php /* Smarty version 2.6.12, created on 2015-10-28 15:38:57
         compiled from direito-publico.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
         ...
         <div class="row bloco-breadcrumb">
            <div class="tamanho-max pd-left-5">
               <ol class="breadcrumb">
                  ...
                  <li><a href="direito-publico.php">Atuação</a></li>
                  <li>Tribunal de Contas</li>
               </ol>
            </div>
         </div>
         <!-- Banner -->
 ...
 ?>
               <div class="col-xs-12 col-sm-9 col-md-9 pd-none bloco-conteudo-interna">
                  <div class="col-xs-12 col-sm-12 col-md-12 pd-none bloco-profissional">
                     <h1 class="titulo-pag font-normal">TRIBUNAL DE CONTAS</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal">
                        Atua na fiscalização contábil, financeira, orçamentária, operacional e patrimonial de estados, municípios e da União, além das respectivas entidades de administração direta ou indireta e fundações, quanto à legalidade, legitimidade, economicidade, aplicação de subvenções e renúncia de receitas.<br><br>
