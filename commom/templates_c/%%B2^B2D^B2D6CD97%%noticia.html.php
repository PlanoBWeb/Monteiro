<?php /* Smarty version 2.6.12, created on 2015-11-12 17:54:45
               ...
               <div class="col-xs-12 col-sm-8 col-md-8 pd-none encapsula-noticias">
                  <div class="col-xs-12 col-sm-12 col-md-12 pd-none conteudo-interna-not">
                     <div class="bloco-imprimi">
                        <img class="img-not-ind" src="commom/img/noticias/img-noticia.jpg" title="Noticia" alt="Noticia">
                     ...
                     <div class="row bloco-compartile-not">
                        ...
                        <div class="col-xs-12 col-sm-6 col-md-6 pd-none">
                           ...
                           <form method="post" name="indique">
                              <input class="font-normal form-compartilhe" type="text" name="indique" placeholder="<?php echo $this->_tpl_vars['arrayIdioma']['MN_FORM_EMAIL']; ?>
...">
