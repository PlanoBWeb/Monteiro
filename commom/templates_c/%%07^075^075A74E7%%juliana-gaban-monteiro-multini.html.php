<?php /* Smarty version 2.6.12, created on 2016-04-15 14:27:34
         compiled from juliana-gaban-monteiro-multini.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <title>Marcos Monteiro – Advogada Juliana Gaban Monteiro Multini</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_JULIANA']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_JULIANA']; ?>
</p>
                     <div class="col-xs-12 col-sm-12 col-md-12 pd-none email-profissional">
                        ...
                        <a href="mailto:juliana@gabanmonteiroadv.com.br">juliana@gabanmonteiroadv.com.br</a>
                     </div>
                  </div>
               </div>
            </div>
