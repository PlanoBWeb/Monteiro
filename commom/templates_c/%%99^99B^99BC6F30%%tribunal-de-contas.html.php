<?php /* Smarty version 2.6.12, created on 2015-11-18 14:48:02
         compiled from tribunal-de-contas.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Tribunal de Contas" />
      <title>Marcos Monteiro Sociedade de Advogados – Tribunal de Contas</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_TC']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_TC']; ?>
</p>
                  </div>
               </div>
            </div>
