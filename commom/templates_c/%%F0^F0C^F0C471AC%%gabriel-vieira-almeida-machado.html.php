<?php /* Smarty version 2.6.12, created on 2016-04-28 10:26:57
...
<html lang="pt">
 ...
 – Advogado Gabriel Vieira Almeida Machado</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_GABRIEL']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_GABRIEL']; ?>
</p>
                     <div class="col-xs-12 col-sm-12 col-md-12 pd-none email-profissional">
                        ...
                        <a href="mailto:gabriel@gabanmonteiroadv.com.br">gabriel@gabanmonteiroadv.com.br</a>
                     </div>
                  </div>
               </div>
            </div>
