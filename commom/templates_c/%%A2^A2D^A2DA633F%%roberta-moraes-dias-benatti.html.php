<?php /* Smarty version 2.6.12, created on 2015-11-23 13:51:14
 ...
 ?>
               <div class="col-xs-12 col-sm-9 col-md-9 pd-none bloco-conteudo-interna">
                  ...
                  <div class="col-xs-12 col-sm-12 col-md-12 pd-none bloco-profissional">
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_ROBERTA']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_ROBERTA']; ?>
</p>
                     <div class="col-xs-12 col-sm-12 col-md-12 pd-none email-profissional">
                        ...
                        <a href="mailto:roberta@mmonteiroadv.com.br">roberta@mmonteiroadv.com.br</a>
                     </div>
                  </div>
               </div>
            </div>
