<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:17
         compiled from assessoria-em-campanhas.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em -Assessoria em todas as etapas da campanha eleitoral." />
      <title>Marcos Monteiro Sociedade de Advogados – Assessoria em Campanhas</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_AC']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_AC']; ?>
</p>
                  </div>
               </div>
            </div>
