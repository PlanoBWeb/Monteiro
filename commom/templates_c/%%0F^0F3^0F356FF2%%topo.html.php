<?php /* Smarty version 2.6.12, created on 2016-04-28 18:11:27
                    ...
                    <div class="collapse navbar-toggleable-xs" id="exCollapsingNavbar2">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="nav-item active dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="adm_usuario.php?acao=editar">Editar</a>    
                                    <a class="dropdown-item" href="adm_usuario.php?acao=senha">Alterar Senha</a>
                                </div>
                            </li>
