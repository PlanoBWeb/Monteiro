<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:35
         compiled from registro-e-legalizacao-de-imoveis.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Registro e Legalização de Imóveis" />
      <title>Marcos Monteiro Sociedade de Advogados – Registro e Legalização de Imóveis</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_RLI']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_RLI']; ?>
</p>
                  </div>
               </div>
            </div>
