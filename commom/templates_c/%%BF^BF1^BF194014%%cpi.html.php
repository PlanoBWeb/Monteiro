<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:26
         compiled from cpi.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Acompanhamento de Comissão Parlamentar de Inquérito (CPI)" />
      <title>Marcos Monteiro Sociedade de Advogados – CPI</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_CPI']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_CPI']; ?>
</p>
                  </div>
               </div>
            </div>
