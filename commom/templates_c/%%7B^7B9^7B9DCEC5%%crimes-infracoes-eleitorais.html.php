<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:22
         compiled from crimes-infracoes-eleitorais.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em divulgação de pesquisa fraudulenta e fatos inverídicos." />
      <title>Marcos Monteiro Sociedade de Advogados – Crimes ou infrações eleitorais</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_CIE']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_CIE']; ?>
</p>
                  </div>
               </div>
            </div>
