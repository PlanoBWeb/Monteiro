<?php /* Smarty version 2.6.12, created on 2015-11-18 14:48:41
         compiled from crimes-de-responsabilidade.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Consultoria preventiva para gestores públicos." />
      <title>Marcos Monteiro Sociedade de Advogados – Crimes de Responsabilidade</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_CR']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_CR']; ?>
</p>
                  </div>
               </div>
            </div>
