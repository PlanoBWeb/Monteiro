<?php /* Smarty version 2.6.12, created on 2015-11-18 14:49:44
         compiled from fidelidade-partidaria.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Pedido à Justiça Eleitoral decretação da perda de cargo eletivo" />
      <title>Marcos Monteiro Sociedade de Advogados – Fidelidade Partidária</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_FP']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_FP']; ?>
</p>
                  </div>
               </div>
            </div>
