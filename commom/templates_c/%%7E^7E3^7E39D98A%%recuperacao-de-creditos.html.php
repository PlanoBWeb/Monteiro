<?php /* Smarty version 2.6.12, created on 2016-04-14 12:11:40
         compiled from recuperacao-de-creditos.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Recuperação de Créditos" />
      <title>Marcos Monteiro Sociedade de Advogados – Recuperação de Créditos</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_RCRE']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_RCRE']; ?>
</p>
                  </div>
               </div>
            </div>
