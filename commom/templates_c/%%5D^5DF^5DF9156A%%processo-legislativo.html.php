<?php /* Smarty version 2.6.12, created on 2016-04-14 12:10:49
         compiled from processo-legislativo.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em assessoria a seus clientes na área do processo legislativo" />
      <title>Marcos Monteiro Sociedade de Advogados – Processo Legislativo</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_PL']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_PL']; ?>
</p>
                  </div>
               </div>
            </div>
