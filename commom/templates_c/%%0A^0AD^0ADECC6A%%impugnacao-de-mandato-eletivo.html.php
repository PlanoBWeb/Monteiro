<?php /* Smarty version 2.6.12, created on 2016-04-14 12:11:23
         compiled from impugnacao-de-mandato-eletivo.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em  pugnar o mandato obtido com abuso de poder econômico, corrupção ou fraude." />
      <title>Marcos Monteiro Sociedade de Advogados – Impugnação de Mandato Eletivo</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_IME']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_IME']; ?>
</p>
                  </div>
               </div>
            </div>
