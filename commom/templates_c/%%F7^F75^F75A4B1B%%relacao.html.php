<?php /* Smarty version 2.6.12, created on 2015-11-16 12:36:55
         compiled from admin/publicacoes/relacao.html */ ?>
...
?>
                    <a class="<?php if ($this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']] == $_GET['p']): ?> link-pag-ativo <?php endif; ?>" href="adm_publicacoes.php?acao=pesquisar&p=<?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
"><?php echo $this->_tpl_vars['Numpaginas'][$this->_sections['j']['index']]; ?>
            ...
            <br>
            <table class="table">
                <h1 class="titulo-pag">Publicações</h1>
                <thead>
                    <tr class="cor-tr-btn">
                        <th>Titulo</th>
                        <th>Tipo</th>
...
?>
                        <tr class="hover-tr">
                            ...
                            <td><?php echo $this->_tpl_vars['dados'][$this->_sections['i']['index']]['tipo']; ?>
</td>
