<?php /* Smarty version 2.6.12, created on 2015-11-18 14:51:09
         compiled from mandado-de-seguranca.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Mandado de Segurança" />
      <title>Marcos Monteiro Sociedade de Advogados – Mandado de Segurança</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_MS']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_MS']; ?>
</p>
                  </div>
               </div>
            </div>
