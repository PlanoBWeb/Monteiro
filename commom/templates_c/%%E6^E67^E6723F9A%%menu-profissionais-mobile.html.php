<?php /* Smarty version 2.6.12, created on 2016-04-12 16:48:28
         compiled from ../inc/menu-profissionais-mobile.html */ ?>
<form>
   <select class="select-internas visible-xs-block" id="formRedirect">
      ...
      <option value="milena-araujo.php">Milena Araujo</option>
   </select>
</form>