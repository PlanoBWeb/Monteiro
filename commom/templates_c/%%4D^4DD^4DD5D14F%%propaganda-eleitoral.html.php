<?php /* Smarty version 2.6.12, created on 2015-11-18 14:50:14
         compiled from propaganda-eleitoral.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em -Orientação em relação aos prazos permitidos para cada tipo de propaganda." />
      <title>Marcos Monteiro Sociedade de Advogados – Propaganda Eleitoral</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_PE']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_PE']; ?>
</p>
                  </div>
               </div>
            </div>
