<?php /* Smarty version 2.6.12, created on 2015-11-18 14:51:02
         compiled from debitos-federais-estaduais.html */ ?>
<!DOCTYPE html>
<html lang="pt">
   <head>
      <meta charset="utf-8">
      ...
      <meta name="description" content="Advogados especialistas em Levantamento de certidões negativas relativas aos encargos federais e estaduais." />
      <title>Marcos Monteiro Sociedade de Advogados – Debitos Federais e Estaduais</title>
...
unset($_smarty_tpl_vars);
 ?>
                     <h1 class="titulo-pag font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TITULO_DFE']; ?>
</h1>
                     <br><br>                  
                     <p class="txt-interna font-normal"><?php echo $this->_tpl_vars['arrayIdioma']['MN_TXT_DFE']; ?>
</p>
                  </div>
               </div>
            </div>
